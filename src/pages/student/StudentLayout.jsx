        ...
        <header className="cluster-topbar student-topbar">
          ...
          <div className="cluster-tools">
            ...
            <div className={`cluster-profile-menu ${profileOpen ? "open" : ""}`}>
              ...
              <div>
                <button onClick={() => { navigate("/student/profile"); setProfileOpen(false); }} type="button"><FiUser /> Profile Settings</button>
                <button onClick={() => { navigate("/student/security"); setProfileOpen(false); }} type="button"><FiShield /> Security & Privacy</button>
