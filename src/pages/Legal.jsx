...
const pages = {
  ...
  "/storage": ["Cookies & Local Storage", [
    ...
    ["Exam Recovery Data", "During an active exam, localStorage may temporarily store answers, recorded violations, scan status, start time and timer state for interruption recovery. Authoritative exam attempts, answers, violations and evidence may also be stored in Supabase. Clearing browser storage can remove local recovery information but does not delete backend records."],
